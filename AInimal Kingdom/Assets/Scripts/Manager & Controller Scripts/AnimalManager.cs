...
public class AnimalManager : MonoBehaviour
{
    ...
    private void SetAllAnimalsToDead()
    {
    ...
    private int AmountOfDeadAnimalsInThisPopulation(AnimalPopulation animalPopulation)
    {
    ...
    private void RepopulateThisAnimalPopulation(AnimalPopulation animalPopulation)
    {
    ...
    private void ReviveThisAnimal(Animal animal, AnimalPopulation animalPopulation)
    {
        animal.ReviveThisAnimal();
        PlaceAnimalAtSpawnLocation(animal, animalPopulation);
    }

    private void PlaceAnimalAtSpawnLocation(Animal animal, AnimalPopulation animalPopulation)
    {
